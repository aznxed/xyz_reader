...
public class LogoBehavior extends CoordinatorLayout.Behavior<ImageView>{
    ...
    public LogoBehavior(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mCustomFinalYPosition = a.getDimension(R.styleable.LogoBehavior_finalYPosition, 0);
            mCustomStartXPosition = a.getDimension(R.styleable.LogoBehavior_startXPosition, 0);
            mCustomStartToolbarPosition = a.getDimension(R.styleable.LogoBehavior_startToolbarPosition, 0);
            mCustomStartHeight = a.getDimension(R.styleable.LogoBehavior_startHeight, 0);
