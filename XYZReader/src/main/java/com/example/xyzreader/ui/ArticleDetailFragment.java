                    ...
                    .get(mCursor.getString(ArticleLoader.Query.PHOTO_URL), new ImageLoader.ImageListener() {
                        ...
                        public void onResponse(ImageLoader.ImageContainer imageContainer, boolean b) {
                            ...
                            if (bitmap != null) {
                                ...
                                collapsingToolbarLayout.setStatusBarScrimColor(p.getDarkMutedColor(mMutedColor));
                                collapsingToolbarLayout.setContentScrimColor(p.getMutedColor(mMutedColor));
                            }
                        }
